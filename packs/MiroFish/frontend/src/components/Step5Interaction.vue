              ...
              <div v-if="showAgentDropdown" class="dropdown-menu">
                ...
                >
                  ...
                  <div class="agent-info">
                    ...
                    <span class="agent-role">{{ agent.profession || 'Profesion desconocida' }}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Generacion de reporte智能体的快速对话版本，可调用 4 种专业工具，拥有MiroFish的完整记忆</div>
              </div>
              ...
              <div class="tools-grid">
                ...
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">自主式访谈，能够并行与模拟世界中个体进行多rondas对话，采集非结构化的观点数据与心理状态</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="profile-card-header">
              ...
              <div class="profile-card-info">
                ...
                <div class="profile-card-meta">
                  ...
                  <span class="profile-card-profession">{{ selectedAgent.profession || 'Profesion desconocida' }}</span>
                </div>
              </div>
              ...
              <div class="agents-grid">
                ...
                >
                  ...
                  <div class="checkbox-info">
                    ...
                    <span class="checkbox-role">{{ agent.profession || 'Profesion desconocida' }}</span>
                  </div>
              ...
              >
                <div class="result-header">
                  ...
                  <div class="result-info">
                    ...
                    <span class="result-role">{{ result.profession || 'Profesion desconocida' }}</span>
                  </div>
                </div>
...
// Lifecycle
onMounted(() => {
  addLog('Step5 Interaccion profunda初始化')
  loadReportData()
  loadProfiles()
